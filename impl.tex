...
In this section, we did not consider the fixup code needed, but instead plainly focused on unrolling the loop and making it run less than or equal times.
