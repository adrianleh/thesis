\begin{abstract}
    ...
    When experimentally evaluating the approach, it becomes clear that without further optimization loop unrolling is not beneficial, as we cannot note any speed-up outside of the margin of error.
\end{abstract}