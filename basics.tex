...
To better handle code and give it a logical structure, most compilers divide code up into so-called basic blocks.
...
In oTo explain this concept, we define a starting node $S$, and assume there are two (not necessarily different) nodes, present in the CFG, $N_1$, and $N_2$.
