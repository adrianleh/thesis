...
To evaluate to what extent this goal was achieved\footnote{N.B.: The test was conducted with a max loop size of $\infty$}, we ran the benchmark suite \texttt{spec2006}, and logged how many loops we encountered, how many of them were innermost loops, how many could be unrolled using the old method, and how many that were previously not unrollable can now be unrolled.
