...
Since loops involve node duplication, it is worth mentioning, that upon duplication a node will have a field called \texttt{link} set to reference the copied node and vice-versa.
