...
The, admittely straighforward, algorithm that is going to used, will try to find a factor $f = 2^n, n \in \mathbb{N}_{>0}$, that will minimize the euclidean distance between the unrolled size, and a pre-determined maximum size.
